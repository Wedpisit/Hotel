  ...
  <div >
    ...
    <div v-if="blog">
      <div class="hero-wrapper">
          <img src="@/assets/hoteltwo.png" width="210"  height="200" class="logo" style="float: left" />
      ...
      <div class="blog-wrapper" v-if="blog != null">
        <h1>{{ blog.title }}</h1>
        <p>
          <strong>รูปภาพห้องพักเพิ่มเติม: </strong>:
...
<p>status: {{ blog.status }}</p> -->
      ...
      <div class="back-nav">
        <button class="btn btn-outline-secondary" v-on:click="navigateTo('/front')">
